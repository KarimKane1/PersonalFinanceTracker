...
export function Sidebar({ currentPage, onPageChange, currentProfileName, onLogout }: SidebarProps) {
  ...
  return (
    <div className="w-64 flex-shrink-0 bg-gradient-to-b from-blue-600 to-blue-700 h-screen sticky top-0 shadow-lg flex flex-col">
      ...
      <div className="p-6 border-t border-blue-500/30">
        <div className="mb-3 text-xs text-blue-200 font-medium">{currentProfileName}</div>
        <button
          onClick={onLogout}
